...
```{r}
unnested_doc_info_df1 |> 
  filter(Topic == 0 & Representative_document == TRUE)
```
...
```{r}
visualize_heatmap <- function(model = topic_model, 
  ...
  # Visualize topics
  fig <- topic_model$visualize_heatmap(custom_labels=FALSE)
