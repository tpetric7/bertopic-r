...
```{r}
hdbscan_model <- HDBSCAN(min_cluster_size=15L, min_samples = 10L, metric='euclidean', cluster_selection_method='eom', gen_min_span_tree=TRUE, prediction_data=TRUE, core_dist_n_jobs = 1)
...
```{r}
#| echo: false
knitr::include_graphics("inst/extdata/topics_topwords_interactive_barchart.png")
```
...
```{r}
#| echo: false
knitr::include_graphics("inst/extdata/topic_dist_interactive.png")
```
...
```{r}
#| echo: false
knitr::include_graphics("inst/extdata/intertopic_distance_map.png")
```
...
```{r}
#| echo: false
knitr::include_graphics("inst/extdata/topics_similarity_heatmap.png")
```
...
```{r}
#| echo: false
knitr::include_graphics("inst/extdata/topic_hierarchy.png")
```
...
```{r}
#| echo: false
knitr::include_graphics("inst/extdata/visualize_documents.png")
```
...
```{r}
#| echo: false
knitr::include_graphics("inst/extdata/visualize_documents_3d.png")
```
...
```{r}
#| echo: false
knitr::include_graphics("inst/extdata/topics_over_time.png")
```
...
```{r}
#| echo: false
knitr::include_graphics("inst/extdata/topics_per_class.png")
```
